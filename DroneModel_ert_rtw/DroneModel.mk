...
## Generated on : Thu Mar 21 14:07:09 2024
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DroneModel.elf
...
DEFINES_STANDARD = -DMODEL=DroneModel -DNUMST=2 -DNCSTATES=12 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c MW_MPU9250.c DroneModel.c DroneModel_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o MW_MPU9250.c.o DroneModel.c.o DroneModel_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
DroneModel.c.o : DroneModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DroneModel_data.c.o : DroneModel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
