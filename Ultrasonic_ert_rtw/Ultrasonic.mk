...
## Generated on : Thu Jun 20 17:33:14 2024
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Ultrasonic.elf
...
DEFINES_STANDARD = -DMODEL=Ultrasonic -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_digitalIO.c Ultrasonic.c Ultrasonic_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_digitalIO.c.o Ultrasonic.c.o Ultrasonic_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
Ultrasonic.c.o : Ultrasonic.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Ultrasonic_data.c.o : Ultrasonic_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
