###########################################################################
## Makefile generated for component 'Calibration'. 
## 
## Makefile     : Calibration.mk
## Generated on : Fri May 24 17:31:58 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Calibration.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Calibration.elf
...
DEFINES_STANDARD = -DMODEL=Calibration -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = Calibration.c Calibration_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = Calibration.c.o Calibration_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
Calibration.c.o : Calibration.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Calibration_data.c.o : Calibration_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
