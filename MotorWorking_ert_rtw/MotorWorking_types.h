...
#ifndef MotorWorking_types_h_
#define MotorWorking_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_beagleboneblue_bbblueServo_Mo_T
#define typedef_beagleboneblue_bbblueServo_Mo_T

typedef struct tag_VIgeb4UfEy1UvclkadFbY beagleboneblue_bbblueServo_Mo_T;

#endif                             /* typedef_beagleboneblue_bbblueServo_Mo_T */
...
#ifndef typedef_cell_wrap_MotorWorking_T
#define typedef_cell_wrap_MotorWorking_T

typedef struct tag_BlgwLpgj2bjudmbmVKWwDE cell_wrap_MotorWorking_T;

#endif                                 /* typedef_cell_wrap_MotorWorking_T */
...
struct tag_V9i0BeISxaZywwPOT5PprG
{
  ...
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_MotorWorking_T inputVarSize;
  real_T ForgettingFactor;
...
#ifndef typedef_dsp_simulink_MovingAverage_Mo_T
#define typedef_dsp_simulink_MovingAverage_Mo_T

typedef struct tag_V9i0BeISxaZywwPOT5PprG dsp_simulink_MovingAverage_Mo_T;

#endif                             /* typedef_dsp_simulink_MovingAverage_Mo_T */

/* Parameters (default storage) */
typedef struct P_MotorWorking_T_ P_MotorWorking_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_MotorWorking_T RT_MODEL_MotorWorking_T;

#endif                                 /* MotorWorking_types_h_ */
