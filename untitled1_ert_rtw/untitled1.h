...
typedef struct {
  ...
  beagleboneblue_bbblueServo_un_T obj_i;/* '<Root>/Motor 3' */
  beagleboneblue_bbblueServo_un_T obj_l;/* '<Root>/Motor 2' */
  beagleboneblue_bbblueServo_un_T obj_b;/* '<Root>/Motor 1' */
...
struct P_untitled1_T_ {
  real_T CompareToConstant1_const;   /* Mask Parameter: CompareToConstant1_const
                                      ...
                                      */
  real_T Constant_Value[4];            /* Expression: [40;40;40;40]
...
extern void untitled1_step2(void);
 ...
 *
 * '<Root>' : 'untitled1'
 * '<S1>'   : 'untitled1/Compare To Constant1'
 */
#endif                                 /* untitled1_h_ */
