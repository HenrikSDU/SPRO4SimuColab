###########################################################################
## Makefile generated for component 'pressure'. 
## 
## Makefile     : pressure.mk
## Generated on : Mon May 20 10:25:36 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pressure.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pressure.elf
...
DEFINES_STANDARD = -DMODEL=pressure -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c pressure.c pressure_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o pressure.c.o pressure_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o rt_zcfcn.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
pressure.c.o : pressure.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pressure_data.c.o : pressure_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
