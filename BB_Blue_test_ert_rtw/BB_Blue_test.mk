###########################################################################
## Makefile generated for component 'BB_Blue_test'. 
## 
## Makefile     : BB_Blue_test.mk
## Generated on : Thu Mar 21 14:21:46 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BB_Blue_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BB_Blue_test.elf
...
DEFINES_STANDARD = -DMODEL=BB_Blue_test -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c MW_MPU9250.c BB_Blue_test.c BB_Blue_test_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o MW_MPU9250.c.o BB_Blue_test.c.o BB_Blue_test_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
BB_Blue_test.c.o : BB_Blue_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BB_Blue_test_data.c.o : BB_Blue_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
