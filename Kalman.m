...
% Display the result
disp(['The variance of pitch rate is: ' num2str(variance_GyroPitch)]);
...
% Display the result
disp(['The variance of magnetoeter is: ' num2str(variance_Mag1)]);
...
disp(['The variance of z (barometer) is: ' num2str(variance_Height)]);
...
disp(['The variance of the roll points is: ' num2str(variance_rollAngle)]);
...
disp(['The variance of pitch angle is: ' num2str(variance_pitchAngle)]);
...
disp(['The variance of yaw points is: ' num2str(variance_Yaw)]);
...
disp(['The variance ofroll rate is: ' num2str(variance_GyroRoll)]);
...
disp(['The variance of the yaw rate is: ' num2str(variance_GyroYaw)]);
