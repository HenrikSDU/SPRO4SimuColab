...
void Controller_implementation_step(void)
{
  ...
  Controller_implementation_B.pmLocal =
    Controller_implementation_DW.obj.pStatistic->pmN;
  Controller_implementation_B.max_possible_rot_speed =
    Controller_implementation_DW.obj.pStatistic->plambda;
  Controller_implementation_B.pmLocal = (1.0 - 1.0 /
    Controller_implementation_B.pwLocal) * Controller_implementation_B.pmLocal +
    1.0 / Controller_implementation_B.pwLocal *
    Controller_implementation_B.pitch_tmp;
  Controller_implementation_DW.obj.pStatistic->pwN =
    Controller_implementation_B.max_possible_rot_speed *
    Controller_implementation_B.pwLocal + 1.0;
  Controller_implementation_DW.obj.pStatistic->pmN =
    Controller_implementation_B.pmLocal;
  ...
  if (zcEvent != NO_ZCEVENT) {
     ...
     * */
    Controller_implementation_B.In = Controller_implementation_B.pmLocal;
   ...
   *  MATLABSystem: '<S7>/MPU9250'
   */
  Controller_implementation_B.pitch_tmp = sin(Controller_implementation_B.roll);
  Controller_implementation_B.pwLocal = cos(Controller_implementation_B.roll);
  ...
  Controller_implementation_B.yaw = rt_atan2d_snf
     ...
     * Controller_implementation_B.pwLocal, (Controller_implementation_B.mdata[1]
      * Controller_implementation_B.pitch_tmp +
      Controller_implementation_B.mdata[2] * Controller_implementation_B.pwLocal)
     * sin(Controller_implementation_B.pitch) +
     Controller_implementation_B.mdata[0] * cos
     (Controller_implementation_B.pitch));

  /* Reshape: '<S9>/Reshapey' */
  Controller_implementation_B.Reshapey[0] = Controller_implementation_B.height;
  ...
  for (i = 0; i < 4; i++) {
    Controller_implementation_B.rtb_DersiredMotorThrusts_k =
      ((Controller_implementation_P.K_mm[i + 4] *
       ...
       Controller_implementation_B.pmLocal) + Controller_implementation_P.K_mm[i
      + 12] * Controller_implementation_B.d;
  ...
  Controller_implementation_B.U[1] = (Controller_implementation_B.pitch_tmp -
  ...
  Controller_implementation_B.U[2] =
    ((Controller_implementation_B.req_rotorspeed[1] +
     ...
     (Controller_implementation_B.req_rotorspeed[0] +
      Controller_implementation_B.req_rotorspeed[3])) *
    Controller_implementation_P.dis;
  Controller_implementation_B.U[0] = (Controller_implementation_B.pitch_tmp +
    Controller_implementation_B.req_rotorspeed[2]) +
    Controller_implementation_B.req_rotorspeed[3];
  ...
  Controller_implementation_B.pwLocal = 0.70588235294117652 *
  ...
  Controller_implementation_B.pmLocal = 0.70588235294117652 *
   ...
   *  Saturate: '<S3>/Servo limit'
   */
  rc_servo_send_pulse_normalized(1, (Controller_implementation_B.pitch_tmp -
    90.0) / 60.0);
  ...
  if (Controller_implementation_B.pwLocal >
    ...
    Controller_implementation_B.pwLocal =
      Controller_implementation_P.Servolimit_UpperSat;
  } else if (Controller_implementation_B.pwLocal <
             Controller_implementation_P.Servolimit_LowerSat) {
    Controller_implementation_B.pwLocal =
      Controller_implementation_P.Servolimit_LowerSat;
  }
   ...
   *  Saturate: '<S3>/Servo limit'
   */
  rc_servo_send_pulse_normalized(2, (Controller_implementation_B.pwLocal - 90.0)
    / 60.0);
  ...
  /* Saturate: '<S3>/Servo limit' */
  if (Controller_implementation_B.pmLocal >
      Controller_implementation_P.Servolimit_UpperSat) {
    Controller_implementation_B.pmLocal =
      Controller_implementation_P.Servolimit_UpperSat;
  } else if (Controller_implementation_B.pmLocal <
             Controller_implementation_P.Servolimit_LowerSat) {
    Controller_implementation_B.pmLocal =
      Controller_implementation_P.Servolimit_LowerSat;
  }
   ...
   *  Saturate: '<S3>/Servo limit'
   */
  rc_servo_send_pulse_normalized(4, (Controller_implementation_B.pmLocal - 90.0)
    / 60.0);
...
void Controller_implementation_initialize(void)
{
  ...
  Controller_implementation_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  Controller_implementation_M->Sizes.checksums[0] = (1473862674U);
  Controller_implementation_M->Sizes.checksums[1] = (942155259U);
  Controller_implementation_M->Sizes.checksums[2] = (881928435U);
  Controller_implementation_M->Sizes.checksums[3] = (2157339910U);
