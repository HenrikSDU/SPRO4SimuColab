...
## Generated on : Thu May 23 21:23:03 2024
...
PRODUCT_NAME              = Controller_implementation
MAKEFILE                  = Controller_implementation.mk
MATLAB_ROOT               = .
MATLAB_BIN                = .
MATLAB_ARCH_BIN           = .
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controller_implementation.elf
...
DEFINES_STANDARD = -DMODEL=Controller_implementation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
Controller_implementation.c.o : Controller_implementation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Controller_implementation_data.c.o : Controller_implementation_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
