...
static void cgxe_mdl_start(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S, int_T tid)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S, int_T tid)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
  InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *moduleInstance =
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG *)calloc(1, sizeof
    (InstanceStruct_qKSfSZXZWPHGlAZMQnGbwG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlInitializeConditions(S, mdlInitialize_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlUpdate(S, mdlUpdate_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlDerivatives(S, mdlDerivatives_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlTerminate(S, mdlTerminate_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlEnable(S, mdlEnable_qKSfSZXZWPHGlAZMQnGbwG);
  ssSetmdlDisable(S, mdlDisable_qKSfSZXZWPHGlAZMQnGbwG);
...
static void mdlProcessParameters_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S)
{
}

void method_dispatcher_qKSfSZXZWPHGlAZMQnGbwG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_qKSfSZXZWPHGlAZMQnGbwG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_qKSfSZXZWPHGlAZMQnGbwG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_qKSfSZXZWPHGlAZMQnGbwG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_qKSfSZXZWPHGlAZMQnGbwG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: qKSfSZXZWPHGlAZMQnGbwG.\n"
...
mxArray *cgxe_qKSfSZXZWPHGlAZMQnGbwG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_qKSfSZXZWPHGlAZMQnGbwG_fallback_info(void)
{
