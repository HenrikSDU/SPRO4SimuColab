...
#define S_FUNCTION_NAME                Controller_implementation_cgxe
#include "simstruc.h"
#include "Controller_implementation_cgxe.h"
#define MDL_START

static void mdlStart(SimStruct* S)
{
  unsigned int success;
  success = cgxe_Controller_implementation_method_dispatcher(S,
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 3409377043;
    checksumData[1] = 1695068124;
    checksumData[2] = 228513853;
    checksumData[3] = 506180728;
