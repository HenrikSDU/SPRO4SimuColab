...
static void cgxe_mdl_start(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S, int_T tid)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S, int_T tid)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
  InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *moduleInstance =
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF *)calloc(1, sizeof
    (InstanceStruct_vhCIMhSDxW7vJ4zd5fVmYF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlInitializeConditions(S, mdlInitialize_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlUpdate(S, mdlUpdate_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlDerivatives(S, mdlDerivatives_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlTerminate(S, mdlTerminate_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlEnable(S, mdlEnable_vhCIMhSDxW7vJ4zd5fVmYF);
  ssSetmdlDisable(S, mdlDisable_vhCIMhSDxW7vJ4zd5fVmYF);
...
static void mdlProcessParameters_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S)
{
}

void method_dispatcher_vhCIMhSDxW7vJ4zd5fVmYF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_vhCIMhSDxW7vJ4zd5fVmYF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_vhCIMhSDxW7vJ4zd5fVmYF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_vhCIMhSDxW7vJ4zd5fVmYF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_vhCIMhSDxW7vJ4zd5fVmYF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: vhCIMhSDxW7vJ4zd5fVmYF.\n"
...
mxArray *cgxe_vhCIMhSDxW7vJ4zd5fVmYF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_vhCIMhSDxW7vJ4zd5fVmYF_fallback_info(void)
{
