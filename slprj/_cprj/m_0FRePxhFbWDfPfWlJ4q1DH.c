...
#include "m_0FRePxhFbWDfPfWlJ4q1DH.h"
...
static void cgxe_mdl_start(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S, int_T tid)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S, int_T tid)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
  InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *moduleInstance =
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH *)calloc(1, sizeof
    (InstanceStruct_0FRePxhFbWDfPfWlJ4q1DH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlInitializeConditions(S, mdlInitialize_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlUpdate(S, mdlUpdate_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlDerivatives(S, mdlDerivatives_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlTerminate(S, mdlTerminate_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlEnable(S, mdlEnable_0FRePxhFbWDfPfWlJ4q1DH);
  ssSetmdlDisable(S, mdlDisable_0FRePxhFbWDfPfWlJ4q1DH);
...
static void mdlProcessParameters_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S)
{
}

void method_dispatcher_0FRePxhFbWDfPfWlJ4q1DH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_0FRePxhFbWDfPfWlJ4q1DH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_0FRePxhFbWDfPfWlJ4q1DH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_0FRePxhFbWDfPfWlJ4q1DH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_0FRePxhFbWDfPfWlJ4q1DH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 0FRePxhFbWDfPfWlJ4q1DH.\n"
...
mxArray *cgxe_0FRePxhFbWDfPfWlJ4q1DH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_0FRePxhFbWDfPfWlJ4q1DH_fallback_info(void)
{
