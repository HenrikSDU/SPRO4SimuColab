#ifndef __mwZZjZOJLk8cXVyx07aGQH_h__
#define __mwZZjZOJLk8cXVyx07aGQH_h__
...
#ifndef struct_tag_ixYdSNDj55ZhTT5YGsRmuG
#define struct_tag_ixYdSNDj55ZhTT5YGsRmuG

struct tag_ixYdSNDj55ZhTT5YGsRmuG
{
...
#endif                                 /* struct_tag_ixYdSNDj55ZhTT5YGsRmuG */

#ifndef typedef_beagleboneblue_bbblueServo
#define typedef_beagleboneblue_bbblueServo

typedef struct tag_ixYdSNDj55ZhTT5YGsRmuG beagleboneblue_bbblueServo;

#endif                                 /* typedef_beagleboneblue_bbblueServo */
...
typedef struct tag_arNsAu0k4EKn3oJmOQ4PR b_cell_wrap;
...
#ifndef typedef_InstanceStruct_mwZZjZOJLk8cXVyx07aGQH
#define typedef_InstanceStruct_mwZZjZOJLk8cXVyx07aGQH

typedef struct {
  SimStruct *S;
  beagleboneblue_bbblueServo sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  uint8_T *u0;
} InstanceStruct_mwZZjZOJLk8cXVyx07aGQH;

#endif                                 /* typedef_InstanceStruct_mwZZjZOJLk8cXVyx07aGQH */
...
extern void method_dispatcher_mwZZjZOJLk8cXVyx07aGQH(SimStruct *S, int_T method,
  void* data);
